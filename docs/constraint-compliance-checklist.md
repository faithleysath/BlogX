...
- [ ] After a `v*` tag is pushed, verify the GitHub release contains the four
  workflow-built archives: Linux x86_64, macOS x86_64, macOS aarch64, and
  Windows x86_64. This depends on the external GitHub release run and cannot be
  proven from a local working tree before a tag exists.
